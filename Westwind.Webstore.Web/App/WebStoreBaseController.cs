...
namespace Westwind.Webstore.Web.Controllers
{
    public class WebStoreBaseController : BaseController<WebStoreAppUserState>
    {
        ...
        /// state.
        /// </summary>
        //public WebStoreAppUserState AppUserState => UserState;
       ...
       //
       //              AppUserState = Westwind.AspNetCore.Security.UserState.CreateFromString<WebStoreAppUserState>(_initialAppUserState);
       ...
       //
       //          var cookieTimeoutDays = !UserState.IsAdmin ? wsApp.Configuration.System.CookieTimeoutDays :5;
       //
